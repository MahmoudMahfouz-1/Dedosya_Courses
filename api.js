 ...
 *     description: Fetch a list of all courses with pagination. You can control the number of courses per page and the page number.
 *     parameters:
 *       - in: query
 *         name: limit
 *         schema:
 ...
 *                             example: "Learn the basics of Node.js in this introductory course."
 *                           price:
 *                             type: number
 ...
 *                           type: string
 *                           description: A brief description of the course
 *                           example: "Master advanced Node.js concepts in this in-depth course."
 *                         price:
 *                           type: number
 *                           description: The price of the course
 *                           example: 29.99
 ...
 *       400:
 *         description: Validation error if required fields are missing or invalid
 *         content:
 *           application/json:
 *             schema:
 *               type: object
